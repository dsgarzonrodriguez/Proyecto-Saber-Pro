package com.saberpro.usecases.reports;

import com.saberpro.entities.FiltrosConsulta;
import com.saberpro.infrastructure.gateways.InformeGateway;
import com.saberpro.usecases.ports.InformePort;
import com.saberpro.usecases.ports.InformePort.EstadisticasGlobales;
import com.saberpro.usecases.ports.InformePort.EstadisticasModulo;
...
public class GenerarInformeIAUseCase {
    ...
    private String armarContexto(FiltrosConsulta filtros,
        ...
        String descCiudad    = filtros.getIdModulo()  != null ? "módulo ID " + filtros.getModulo() : "todas las ciudades";
