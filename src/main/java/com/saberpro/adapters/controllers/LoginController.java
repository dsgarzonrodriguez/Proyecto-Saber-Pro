...
import com.saberpro.usecases.user.LoginUsuarioUseCase;
...
public class LoginController {
    ...
    private void onIniciarSesion() {
        ...
        try {
            ...
            abrirVentana("/com/saberpro/adapters/views/Menu.fxml", "Menú principal");
            cerrarVentanaActual();
    ...
    private void onRecuperar() {
        abrirVentana("/com/saberpro/adapters/views/Recuperar.fxml", "Recuperar contraseña");
        cerrarVentanaActual();
    }
