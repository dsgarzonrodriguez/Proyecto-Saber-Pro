...
public class HabilitarUsuarioUseCase {

    private final UsuarioRepository repository;

    public HabilitarUsuarioUseCase(UsuarioRepository repository) {
    ...
    public void ejecutar(int idUsuario) throws SQLException {
        ...
        if (usuario.isHabilitado()) {
            throw new IllegalStateException("Este usuario ya está habilitado.");
        }

        repository.habilitar(usuario);
    }
}