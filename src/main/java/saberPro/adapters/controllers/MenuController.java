...
public class MenuController {
    ...
    private void onGestionCuenta() {
        abrirVentana("/saberPro/adapters/views/Cuenta.fxml", "Gestionar cuenta");
    }

    @FXML
    private void onGestionUsuario() {
        abrirVentana("/saberPro/adapters/views/Usuario.fxml", "Gestionar usuarios");
    }

    @FXML
    private void onGestionRoles() {
        abrirVentana("/saberPro/adapters/views/Rol.fxml", "Gestionar roles");
    }

    @FXML
    private void onCargarUsuarios() {
        abrirVentana("/saberPro/adapters/views/CargaUsuario.fxml", "Carga masiva de usuarios");
    }

    @FXML
    private void onResultadoPersonal() {
        abrirVentana("/saberPro/adapters/views/ResultadoPersonal.fxml", "Resultado personal");
    }

    @FXML
    private void onResultadoGeneral() {
        abrirVentana("/saberPro/adapters/views/ResultadosGenerales.fxml", "Resultados generales");
    }

    @FXML
    private void onCargarResultados() {
        abrirVentana("/saberPro/adapters/views/CargaResultados.fxml", "Cargar resultados");
    }

    @FXML
    private void onGenerarInforme() {
        abrirVentana("/saberPro/adapters/views/Informe.fxml", "Generar informe con IA");
    }
    ...
    private void onCerrarSesion() {
        ...
        confirm.showAndWait().ifPresent(respuesta -> {
            if (respuesta == ButtonType.YES) {
                ...
                abrirVentanaPrincipal("/saberPro/adapters/views/Login.fxml", "SABER PRO - Login");
                cerrarVentanaActual();
            }
        });
    }
