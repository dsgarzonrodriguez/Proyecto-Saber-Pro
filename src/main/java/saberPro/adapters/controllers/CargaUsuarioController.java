...
import saberPro.usecases.user.CargaMasivaUsuarioUseCase;
import saberPro.usecases.user.CargaMasivaUsuarioUseCase.ResultadoCarga;
...
public class CargaUsuarioController {
    ...
    private final CargaMasivaUsuarioUseCase cargaUseCase =
            new CargaMasivaUsuarioUseCase(new UsuarioRepositoryImpl());
